...
export const AliceDialog: Dialog[] = [
  {
    text: "Hi, I'm Arul - welcome to Adobe"
  },
  {
...
export const BobDialog: Dialog[] = [
  {
    text: "G'day human! My name is Raghav and I'm a robot. Would you like to learn more about the history of Decentraland and how it all started?",
    isQuestion: true,
    offsetY: 20,
    buttons: [
...
export const CharlieDialog: Dialog[] = [
  {
    text: "Hey, I'm Atul - a master trader. Would you like to learn more about the Decentraland Marketplace?",
    isQuestion: true,
    offsetY: 20,
    buttons: [
      { label: 'YES', goToDialog: 2 },
